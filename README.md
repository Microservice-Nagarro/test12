...
* Copy code\BHF.MS.test12\yaml\configMap-development.yml.example as "configMap-development.yml"
...
* Every single migration command requires Args parameter containing full query string to the databse, sample command below:
	* Add-Migration InitialMigration -Context CustomDbContext -Project BHF.MS.test12.Database -StartupProject BHF.MS.test12.Database -Args "Data Source=(local);Initial Catalog=test12;User ID=[user];Password=[passwsord];Trust Server Certificate=True"
